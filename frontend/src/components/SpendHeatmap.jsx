...
//         <h2 className="text-lg font-semibold text-[#3A3335]">Spend Over Time</h2>
//         <select
//           value={year}
//           onChange={(e) => {
...
//                 <div
//                   key={dIndex}
//                   title={day ? (day.amount > 0 ? `${day.date}: $${day.amount.toFixed(2)}` : `${day.date}: No expenses`) : ''}
//                   onClick={() => day && setSelectedDay(day.date)}
//                   className={`w-3 h-3 rounded-sm ${day && day.amount > 0 ? 'cursor-pointer hover:ring-2 hover:ring-[#D88C9A]' : ''}`}
//                   style={{
...
//                     <span>{e.shopName}{e.category && ` · ${e.category.name}`}</span>
//                     <span>${e.amount}</span>
//                 </li>
//                 ))}
//             </ul>
